...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя    = "ISEM";
	Описание.Версия = "2023.12.1.0";
	Описание.ИдентификаторИнтернетПоддержки = "ISEM";
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2023.12.1.0"; // для целей тестирования
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("35878ba8-c459-42f8-b259-5f1b79ef8361");
	Обработчик.Процедура = "Справочники.ИнтеграцииСистем.ЗаполнитьДанныеИнтеграцийДляСписка_2023_12_1_0";
	Обработчик.Комментарий = НСтр("ru = 'Заполнение значения дополнительных данных у элементов справочника ""Интеграции систем"" прошлых периодов.
		|До завершения обработки дополнительных данных элементы справочника могут отображаться некорректно.'");
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.ОчередьОтложеннойОбработки = 1;
	Обработчик.ПроцедураЗаполненияДанныхОбновления = "Справочники.ИнтеграцииСистем.ЗарегистрироватДанныеИнтеграцийДляСпискаКОбработкеДляПереходаНа_2023_12_1_0";
	Обработчик.ЧитаемыеОбъекты      = "Справочник.ИнтеграцииСистем";
	Обработчик.ИзменяемыеОбъекты    = "";
	Обработчик.ПроцедураПроверки    = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты   = "Справочник.ИнтеграцииСистем, Отчет.ИнтеграцииСистем";
